...
// divToggle.classList.add("a");
// divToggle.classList.add("b");
// divToggle.classList.add("activ");
// console.log(divToggle);
...
const render = ()=>{
    ...
    // 토글처리
    if (state.toggle) divToggle.classList.add("activ");
    else // console.log("b");
    divToggle.classList.remove("activ");
    //카운터 처리
...
},{}],"497Dv":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _typeofJs = require("./typeof.js");
var _typeofJsDefault = parcelHelpers.interopDefault(_typeofJs);
...
},{"./typeof.js":"i7HWY","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["9ZIyz","adjPd"], "adjPd", "parcelRequirebced")
